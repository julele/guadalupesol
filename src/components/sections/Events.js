        ...
        <div className="row">
          <div className="col-md-7 col-sm-12">
            <div className="my-3">
              ...
              <p>Vas a comprender por qué te cuesta recibir, cómo abriste bloqueos y cómo activar tu merecimiento desde el amor propio.</p>
            ...
            <div className="my-3">
              ...
              <div className="h5">¿Te espero el 7, 8 y 9 de julio.</div>
              <div className="h6">Vamos a encender juntas la chispa que activa TODO lo que ya es tuyo.</div>
          ...
          <div className="col-md-5 col-sm-12">
            <div className="my-3"><img className="img-fluid redondeado" src="images/wedding-party.jpg" alt="Wedding Party"/></div>
          </div>
        </div>
      </div>
    </div>
